import { Book, Heart, MessageSquare, Smile, Users, FileText, Radio, Music, Video, BookOpen, BarChart3, Calendar, Settings } from 'lucide-react';
...
export default function DesktopDock({ onAppClick }: DesktopDockProps) {
  return (
